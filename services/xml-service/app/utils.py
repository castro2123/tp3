...
from xml_handler import csv_to_xml_string, validate_xml
from db_client import insert_xml_document
...
async def process_csv(
    ...
    # Persistir no DB
    try:
        doc_id = insert_xml_document(ID_Requisicao, xml_string, MAPPER_VERSION, status="OK")
